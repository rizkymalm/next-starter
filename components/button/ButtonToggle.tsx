    ...
    return (
        ...
        >
            <input
                ...
                checked={isChecked}
                className="sr-only"
                id="theme-switcher-three"
            />
            <div
                className={`flex h-[46px] w-[82px] items-center justify-center rounded-md shadow-card ${!isChecked ? 'bg-white' : 'bg-black'}`}
            >
                <span
                    className={`flex size-9 items-center justify-center rounded ${
                        !isChecked ? 'bg-blue-400 text-white' : 'text-white'
                    }`}
                >
                    <svg
                        width="16"
