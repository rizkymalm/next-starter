        ...
        <Overlay>
            ...
            >
                <div
                    ...
                    tabIndex={-1}
                    data-open={open}
                    className={`absolute bottom-0 w-full ${widthMap[width]} rounded-t-xl border border-accent-dark/10 bg-light-2 text-text-light-primary shadow-4 transition-all duration-300 focus:outline-none dark:bg-dark-2 dark:text-text-dark-primary ${animationMap[animation]} `}
                >
                    {closeButton &&
                        stackItem &&
                        stack.isTopMost(stackItem.id) && (
