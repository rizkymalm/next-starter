                ...
                >
                    ...
                    <DialogContent>
                        <div className="ty-body custom-scrollbar max-h-72.5 w-full overflow-y-auto">
                            <p>
                                <b>RM Universe</b> is an interactive 3D
                                experience that presents projects as planets
                                inside a living solar system.
                            </p>
                            <p>
                                Instead of scrolling through a traditional
                                website, visitors explore a digital universe
                                where each orbiting planet represents a real
                                product, idea, or experiment.
                            </p>
                            <p>
                                This project transforms a personal portfolio
                                into a<b>navigable experience</b> — blending
                                storytelling, motion, and technology into a
                                single immersive interface.
                            </p>
                            <b>Users can:</b>
                            <ul className="list-inside list-disc">
                                <li>
                                    Rotate and explore the solar system in real
                                    time
                                </li>
                                <li>
                                ...
                                <li>
                                    Experience smooth cinematic transitions
                                    between sections
                                </li>
                            </ul>
                            ...
                            <p>
                                This project is built using modern web graphics
                                and interaction technologies:
                            </p>
                            <ul className="list-inside list-disc">
                                <li>
                                    <b>Three.js</b> for real-time 3D rendering
                                    and orbital animation
                                </li>
                                <li>
                                ...
                                <li>
                                    <b>Framer Motion</b> for smooth transitions
                            ...
                            <p>
                                It showcases not only technical skill, but also
                                the ability to design memorable digital
                                products.
                            </p>
                        </div>
                    </DialogContent>
